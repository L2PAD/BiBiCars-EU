    ...
    >
      ...
      <div className="px-4 py-3 space-y-1.5">
        <p className="text-[10px] uppercase tracking-wider font-bold text-zinc-500 mb-1">
          {lang === 'uk' ? 'Дії менеджера' : lang === 'bg' ? 'Действия' : lang === 'ru' ? 'Действия' : 'Manager actions'}
        </p>
        ...
        <div className="px-4 pb-3">
          <div className="bg-blue-50 border border-blue-200 rounded-lg px-2.5 py-1.5">
            <p className="text-[10px] uppercase tracking-wider font-bold text-blue-700 mb-0.5">
              {lang === 'uk' ? 'Рекомендований крок' : lang === 'bg' ? 'Препоръка' : lang === 'ru' ? 'Рекомендация' : 'Recommended next'}
            </p>
      ...
      <div className="border-t border-zinc-200/70 bg-white">
        ...
        >
          <span>{lang === 'uk' ? 'Деталі' : lang === 'bg' ? 'Детайли' : lang === 'ru' ? 'Детали' : 'Details'}</span>
        ...
        {expanded && (
          <div className="px-4 pb-3 space-y-3">
            ...
            <div>
              <p className="text-[10px] uppercase tracking-wider font-bold text-zinc-500 mb-1">
                {lang === 'uk' ? 'Коментар' : lang === 'bg' ? 'Коментар' : lang === 'ru' ? 'Комментарий' : 'Comment'}
              </p>
              <textarea
                value={comment}
            ...
            <div>
              <p className="text-[10px] uppercase tracking-wider font-bold text-zinc-500 mb-1 flex items-center gap-1">
                ...
                {lang === 'uk' ? 'Ризики' : lang === 'bg' ? 'Рискове' : lang === 'ru' ? 'Риски' : 'Risks'}
            ...
            <div>
              <p className="text-[10px] uppercase tracking-wider font-bold text-zinc-500 mb-1 flex items-center gap-1">
                ...
                {lang === 'uk' ? 'Історія' : lang === 'bg' ? 'История' : lang === 'ru' ? 'История' : 'History'}
              </p>
