 ...
 *
 * App languages: uk / en / bg (ru kept as a harmless fallback). Mirrors the
...
export const TEMP_META = {
  hot:  {
    ...
    labels: { uk: 'Гарячий', en: 'Hot', bg: 'Горещ', ru: 'Горячий' },
  },
  warm: {
    key: 'warm', dot: '#F59E0B', bg: '#FEF3C7', fg: '#92400E', ring: '#FDE68A',
    labels: { uk: 'Теплий', en: 'Warm', bg: 'Топъл', ru: 'Тёплый' },
  },
  cold: {
    key: 'cold', dot: '#EF4444', bg: '#FEE2E2', fg: '#B91C1C', ring: '#FECACA',
    labels: { uk: 'Охолов', en: 'Cold', bg: 'Изстинал', ru: 'Остыл' },
  },
};
